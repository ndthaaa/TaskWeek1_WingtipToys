...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-33dcr21007398_api1.business.example.com";
    private string APIPassword = "56AL3YDTAQDHDMD8";
    private string APISignature = "A8H3ae5-scvvWlx7aRTT68puAZNDALZ1ztczyMoVPe.un3I229iG6fYc";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44330/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44330/Checkout/CheckoutCancel.aspx";
